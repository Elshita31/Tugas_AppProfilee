...
class MainActivity : AppCompatActivity() {
    ...
    private fun validasiInput() {
        ...
        when{
            ...
            genderInput.equals("Pilih Jenis Kelamin") -> ("Jenis Kelamin tidak boleh kosong")
    ...
    private fun navigasiKeProfilDiri(){
        ...
        var namaInput = edtName.text.toString()
        var emailInput = edtEmail.text.toString()
        var telpInput = edtTelp.text.toString()
        var alamatInput = edtAddress.text.toString()
        var genderInput = spinnerGender.selectedItem.toString()
